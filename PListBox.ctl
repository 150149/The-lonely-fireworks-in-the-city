...
Begin VB.UserControl PListBox 
   ...
   ScaleHeight     =   4215
   ScaleWidth      =   3615
   ToolboxBitmap   =   "PListBox.ctx":0000
   Begin VB.Timer Timer1 
      ...
      Top             =   1200
   End
   Begin ÊÐ¾®ÖÐ¹Â°ÁµÄÑÌ»ð.PVScrollBar H 
      Height          =   1215
      Left            =   480
      TabIndex        =   1
      Top             =   0
...
Public Function ItemIsExists(ByVal Item As Variant, Optional ByVal Index As Long = 0) As Boolean
    ItemIsExists = False
    If (Index > (Total - 1)) Or (Index < 0) Then Exit Function
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    C_Distance_Item = PropBag.ReadProperty("Distance_Item", 15)
    C_Height_Item = PropBag.ReadProperty("Height_Item", 300)
    C_Font_Size_Selected = PropBag.ReadProperty("Font_Size_Selected", 15)
    ...
    C_Style_Number = PropBag.ReadProperty("Style_Number", 0)
    UserControl.BackColor = C_Color_Back
    UserControl.ForeColor = C_Color_Text
    Set UserControl.Picture = C_Picture
    H.Color_Top = C_Color_Top_ScrollBar
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("Distance_Item", C_Distance_Item, 15)
    Call PropBag.WriteProperty("Height_Item", C_Height_Item, 300)
    Call PropBag.WriteProperty("Font_Size_Selected", C_Font_Size_Selected, 15)
    ...
    Call PropBag.WriteProperty("Style_Number", C_Style_Number, 0)
End Sub
