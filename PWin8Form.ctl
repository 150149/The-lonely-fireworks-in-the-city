...
Begin VB.UserControl PWin8Form 
   ...
   Begin ÊÐ¾®ÖÐ¹Â°ÁµÄÑÌ»ð.PUIMgr PM 
      ...
      _ExtentY        =   847
   End
   Begin ÊÐ¾®ÖÐ¹Â°ÁµÄÑÌ»ð.PUIMgr PUI 
      Left            =   600
      Top             =   0
      _ExtentX        =   847
      _ExtentY        =   847
   End
   Begin ÊÐ¾®ÖÐ¹Â°ÁµÄÑÌ»ð.PButton PBBig 
      Height          =   315
      Left            =   3450
      TabIndex        =   4
      Top             =   15
   ...
   Begin VB.PictureBox picContainer 
      ...
      Width           =   4455
   End
   Begin ÊÐ¾®ÖÐ¹Â°ÁµÄÑÌ»ð.PButton PBClose 
      Height          =   315
      Left            =   3840
      TabIndex        =   0
      Top             =   15
      ...
      Text_Deviate_Y  =   -2
   End
   Begin ÊÐ¾®ÖÐ¹Â°ÁµÄÑÌ»ð.PButton PBSmall 
      Height          =   315
      Left            =   3060
      TabIndex        =   5
      Top             =   15
      ...
      Can_Text_Move   =   0   'False
   End
   Begin ÊÐ¾®ÖÐ¹Â°ÁµÄÑÌ»ð.PUIMgr PUI2 
      Left            =   1080
      Top             =   0
      _ExtentX        =   847
      _ExtentY        =   847
...
'Dim nLeft As Integer, nTop As Integer, nWidth As Integer, nHeight As Integer
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    C_Can_Move_Smoothly = PropBag.ReadProperty("Can_Move_Smoothly", True)
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("Can_Move_Smoothly", C_Can_Move_Smoothly, True)
