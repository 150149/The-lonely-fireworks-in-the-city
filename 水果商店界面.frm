...
Private Sub Form_Load()
    ...
    KeyPreview = True
    Image1(0).Picture = LoadPicture(App.Path & "\picture\item\4.gif")
    Image1(1).Picture = LoadPicture(App.Path & "\picture\item\9.gif")
    Image1(2).Picture = LoadPicture(App.Path & "\picture\item\15.gif")
    Image1(3).Picture = LoadPicture(App.Path & "\picture\item\18.gif")
    Image1(4).Picture = LoadPicture(App.Path & "\picture\item\21.gif")
    Image1(5).Picture = LoadPicture(App.Path & "\picture\item\23.gif")
    Image1(6).Picture = LoadPicture(App.Path & "\picture\item\25.gif")
    Image1(7).Picture = LoadPicture(App.Path & "\picture\item\31.gif")
