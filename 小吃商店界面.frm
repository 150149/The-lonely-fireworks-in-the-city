...
Private Sub Form_Load()
    ...
    KeyPreview = True
    Image1(0).Picture = LoadPicture(App.Path & "\picture\item\1.gif")
    Image1(1).Picture = LoadPicture(App.Path & "\picture\item\3.gif")
    Image1(2).Picture = LoadPicture(App.Path & "\picture\item\5.gif")
    ...
    Image1(7).Picture = LoadPicture(App.Path & "\picture\item\37.gif")
    Image1(8).Picture = LoadPicture(App.Path & "\picture\item\29.gif")
