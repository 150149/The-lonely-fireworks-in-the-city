...
Begin VB.UserControl PPictureBox 
   ...
   ScaleHeight     =   5430
   ScaleWidth      =   6390
   ToolboxBitmap   =   "PPictureBox.ctx":0000
   Begin ÊÐ¾®ÖÐ¹Â°ÁµÄÑÌ»ð.PUIMgr PUIMgr1 
      Left            =   3240
      Top             =   1920
      _ExtentX        =   847
      _ExtentY        =   847
   End
   Begin ÊÐ¾®ÖÐ¹Â°ÁµÄÑÌ»ð.PVScrollBar PV 
      Height          =   5175
      Left            =   6120
      TabIndex        =   2
      Top             =   0
      ...
      Enabled         =   0   'False
   End
   Begin ÊÐ¾®ÖÐ¹Â°ÁµÄÑÌ»ð.PHScrollBar PH 
      Height          =   255
      Left            =   0
      TabIndex        =   1
      Top             =   5160
...
Private Sub PV_Scroll(nValue As Single)
    Pic2.Top = -(Pic2.Height - Pic1.Height) * nValue
...
Private Sub PH_Scroll(nValue As Single)
    Pic2.Left = -(Pic2.Width - Pic1.Width) * nValue
    If Is_Enabled = True Then RaiseEvent Scroll
End Sub
