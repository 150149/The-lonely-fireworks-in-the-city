...
' SolidBkgColor - Optional solid color to render GIF over
...
Attribute SolidBkgColor.VB_Description = "Transparent GIFs will be rendered over this background color"
...
Attribute SolidBkgColorUsed.VB_Description = "Use the SolidBkgColor property otherwise ignore it"
    ' option to render frames over a solid backgroun color
...
Private Function BuildDIBstrip(InitialLoad As Boolean) As Boolean
    ...
    ' Ex: 100 frames, 32x32 GIF: what's better, 1 bmps or 100 stdPictures?
